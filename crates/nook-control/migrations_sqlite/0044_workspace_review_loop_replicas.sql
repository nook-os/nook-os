...
--
-- Per-workspace review-loop replicas (MAIN-445 AC-1). SQLite has no
...
-- existing row reads NULL — "unset, use the build's default of one" — exactly
-- as on Postgres.
ALTER TABLE workspaces ADD COLUMN review_loop_replicas INTEGER;
