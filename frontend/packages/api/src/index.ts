...
export type BoardHealth = Schemas["BoardHealth"];
export type BoardHealthCheck = Schemas["BoardHealthCheck"];
export type BoardHealthCheckKind = Schemas["BoardHealthCheckKind"];
